var Jobick = (function () {
  ...
  $(window).height();
  var t = function () {
      jQuery(".default-select,.dataTables_wrapper select").length > 0 &&
    ...
    w = function () {
      jQuery(".bt-datepicker").length > 0 &&
        $(".bt-datepicker")
          .datepicker({ autoclose: !0, todayHighlight: !0 })
    ...
    E = function () {
      e > 1024 &&
        $(".metismenu  li")
          ...
          .each(function (e) {
            if ($("ul", this).length > 0) {
              var t = $("ul:first", this).css("display", "block"),
                n = t.offset().left,
                a = t.width(),
                t = $("ul:first", this).removeAttr("style");
              $("body").height();
              var l = $("body").width();
              if (jQuery("html").hasClass("rtl")) var i = n + a <= l;
              else var i = n > 0;
              i
    ...
    z = function () {
      if (jQuery(".dlab-theme-mode").length > 0) {
        ...
        jQuery("body").attr("data-theme-version", e),
          ...
          setTimeout(function () {
            "dark" === jQuery("body").attr("data-theme-version") &&
