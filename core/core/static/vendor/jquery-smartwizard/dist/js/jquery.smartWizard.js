    ...
    _createClass(SmartWizard, [
      ...
      },
      {
        ...
        value: function _setEvents() {
          ...
          $(this.steps).on("click", function (e) {
            ...
            if (
              _this.options.anchorSettings.enableAnchorOnDoneStep === false &&
              _this._isDone(idx)
            ) {
              return true;
            }
            ...
            if (
              _this.options.anchorSettings.enableAllAnchors !== false ||
              _this._isDone(idx)
            ) {
              _this._showStep(idx);
            }
      ...
      },
      {
        ...
        value: function _createToolbar(position) {
          ...
          var toolbar = $("<div></div>")
            ...
            .attr("role", "toolbar"); // Create the toolbar buttons
          ...
          var btnPrevious =
            this.options.toolbarSettings.showPreviousButton !== false
              ? $("<button></button>")
                  ...
                  .addClass("btn btn-primary sw-btn-prev")
                  .attr("type", "button")
              : null;
      ...
      },
      {
        ...
        value: function _loadStep(idx) {
          ...
          var getStepContent = this._triggerEvent("stepContent", [
            selStep,
            idx,
            stepDirection,
          ]);
      ...
      },
      {
        ...
        value: function _transitStep(idx) {
          ...
          this._doStepAnimation(idx, function () {
            ...
            _this5._triggerEvent("showStep", [
              selStep,
              _this5.current_index,
              stepDirection,
              stepPosition,
            ]);
            ...
            case "slide-s":
              ...
              if (curPage) {
                curPage.slideUp(
                  ...
                  function () {
                    selPage.slideDown(
                      _this6.options.transition.speed,
                      _this6.options.transition.easing,
                      function () {
                        callback();
                      }
                    );
